  ...
  return (
    <>
      <PageHero
        ...
        description="Пять дневных маршрутов по сложности. Новый клиент в личном кабинете начинает с «Зелёного озера» — дальше трассы открываются по порядку."
        image={IMAGES.heroRoutes.src}
        imageAlt={IMAGES.heroRoutes.alt}
      >
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl">
          {["5 авторских маршрутов", "45 мин – 2+ ч", "Разная сложность", "Фотостопы"].map(
            (t) => (
