...
export const SITE = {
  ...
  logo: asset("/images/brand/logo-volnitsa-runa-transparent.png"),
  logoAlt: "Вольница — территория свободы",
  logoFull: asset("/images/brand/logo-volnitsa-runa-transparent.png"),
  logoFullAlt:
    "Логотип Вольница: руна и ели, надпись «Вольница — территория свободы»",
  /** Компактный знак без текста (иконки, фавикон) */
  logoMark: asset("/images/brand/logo-volnitsa-znak.png"),
...
export const ROUTES: Route[] = [
  {
    ...
    progressOrder: 1,
    image: asset("/images/routes/zelenoe-ozero.jpg"),
    imageAlt:
  ...
  },
  {
    ...
    progressOrder: 2,
    image: asset("/images/routes/pamyatnik.jpg"),
    imageAlt:
  ...
  },
  {
    ...
    progressOrder: 3,
    image: asset("/images/routes/rodnik.jpg"),
    imageAlt:
  ...
  },
  {
    ...
    progressOrder: 4,
    image: asset("/images/routes/ekspediciya.jpg"),
    imageAlt:
  ...
  },
  {
    ...
    progressOrder: 5,
    image: asset("/images/routes/lesnye-tropy.jpg"),
    imageAlt:
  ...
  awaits: [
    {
      ...
      image: asset("/images/hero/nochnoj-kvest-farami-luna.jpg"),
      imageAlt: "Квадроциклы ночью на лесной тропе с фарами",
    },
    {
      title: "Смотровые",
      text: "Паузы с видом на ночной лес.",
      image: asset("/images/gallery/sosna-prud-ryaska.jpg"),
      imageAlt: "Вид на природу у воды",
    },
    {
      title: "Костёр",
      text: "Тёплая остановка в середине пути.",
      image: asset("/images/gallery/kostyor-noch-kvadrocikly.jpg"),
...
export const FLEET: FleetItem[] = [
  {
    ...
    seats: 2,
    drive: "4×4",
    image: asset("/images/fleet/chernyj-kvadrocikl-gryaz-zakat.jpg"),
  ...
  },
  {
    ...
    seats: 2,
    drive: "4×4",
    image: asset("/images/fleet/krasnyj-kvadrocikl-lesnaya-tropa.jpg"),
  ...
  },
  {
    ...
    seats: 2,
    drive: "4×4",
    image: asset("/images/fleet/oranzhevyj-utv-les.jpg"),
...
export const GALLERY_SEED: GallerySeedItem[] = [
  {
    ...
    category: "atv",
    src: asset("/images/gallery/dva-kvadrocikla-u-pruda.jpg"),
  ...
  },
  {
    ...
    category: "atv",
    src: asset("/images/gallery/muzhchiny-kvadrocikly-u-pruda.jpg"),
  ...
  },
  {
    ...
    category: "atv",
    src: asset("/images/gallery/krasnyj-kvadrocikl-vysokaya-trava.jpg"),
  ...
  },
  {
    ...
    title: "Лесная тропа",
    category: "routes",
    src: asset("/images/gallery/tropa-berezy-listva.jpg"),
  ...
  },
  {
    ...
    title: "Пруд с ряской",
    category: "nature",
    src: asset("/images/gallery/prud-ryaska-otrazhenie-lesa.jpg"),
  ...
  },
  {
    ...
    title: "Сосна у пруда",
    category: "nature",
    src: asset("/images/gallery/sosna-prud-ryaska.jpg"),
  ...
  },
  {
    ...
    category: "nature",
    src: asset("/images/gallery/les-piknik-stol-sosny.jpg"),
  ...
  },
  {
    ...
    category: "manor",
    src: asset("/images/gallery/les-skamejka-skvorechniki.jpg"),
  ...
  },
  {
    ...
    category: "nature",
    src: asset("/images/gallery/poliana-sosny-berezy.jpg"),
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Детей берём с 6 лет — с соблюдением безопасности и экипировки. Условия для водителя и пассажира уточняйте при бронировании.",
    icon: "users" as const,
  },
  {
